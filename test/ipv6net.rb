...
assert("NetAddr::IPv6Net.parse") do
...
assert("NetAddr::IPv6Net.contains") do
...
assert("NetAddr::IPv6Net.fill") do
...
assert("NetAddr::IPv6Net.next") do
...
assert("NetAddr::IPv6Net.next_sib") do
...
assert("NetAddr::IPv6Net.prev_sib") do
...
assert("NetAddr::IPv6Net.resize") do
  assert_equal("1::/64", NetAddr::IPv6Net.parse("1::/63").resize(64).to_s)
end

assert("NetAddr::IPv6Net.subnet_count") do
...
assert("NetAddr::IPv6Net.summ") do
