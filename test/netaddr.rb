...
assert('NetAddr.sort_IPv4Net') do
  nets = []
...
assert('NetAddr.summ_IPv4Net') do
  nets = []
...
assert('NetAddr.sort_IPv6Net') do
  nets = []
...
assert('NetAddr.summ_IPv6Net') do
  nets = []
