...
assert("NetAddr::IPv4Net.parse") do
...
assert("NetAddr::IPv4Net.contains") do
...
assert("NetAddr::IPv4Net.len") do
  net1 = NetAddr::IPv4Net.parse("1.1.1.0/24")
  assert_equal(256, net1.len())
end

assert("NetAddr::IPv4Net.next") do
...
assert("NetAddr::IPv4Net.next_sib") do
...
assert("NetAddr::IPv4Net.prev") do
...
assert("NetAddr::IPv4Net.prev_sib") do
...
assert("NetAddr::IPv4Net.summ") do
